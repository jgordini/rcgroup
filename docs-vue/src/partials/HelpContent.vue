<template>
  <div>
    <header class="mb-8">
      <h1 class="h2 text-slate-800 mb-4 dark:text-slate-200">How can we help?</h1>
      <p class="text-lg text-slate-600 dark:text-slate-400">Everything you need to know right here at your fingertips. Ask questions, browse
        around for answers, or submit your feature requests.</p>
    </header>
    <div class="text-slate-600 dark:text-slate-400 space-y-8">

      <!-- Faqs section -->
      <div class="space-y-8 mb-12 md:mb-16">

        <section class="space-y-4">
          <!-- HTML Bookmark -->
          <!-- The data-scrollspy-target attribute makes the scrollspy work -->
          <h2 id="overview" data-scrollspy-target class="h4 text-slate-800 scroll-mt-24 dark:text-slate-200">Overview</h2>
          <ul class="space-y-3">
        ...
        <section class="space-y-4">
          <!-- HTML Bookmark -->
          <!-- The data-scrollspy-target attribute makes the scrollspy work -->
          <h2 id="support" data-scrollspy-target class="h4 text-slate-800 scroll-mt-24 dark:text-slate-200">Support</h2>
          <ul class="space-y-3">
        ...
        <section class="space-y-4">
          <!-- HTML Bookmark -->
          <!-- The data-scrollspy-target attribute makes the scrollspy work -->
          <h2 id="security" data-scrollspy-target class="h4 text-slate-800 scroll-mt-24 dark:text-slate-200">Security &amp; Privacy</h2>
          <ul class="space-y-3">
        ...
        <section class="space-y-4">
          <!-- HTML Bookmark -->
          <!-- The data-scrollspy-target attribute makes the scrollspy work -->
          <h2 id="troubleshooting" data-scrollspy-target class="h4 text-slate-800 scroll-mt-24 dark:text-slate-200">Troubleshooting</h2>
          <ul class="space-y-3">
